        ...
        {!loading && files.length === 0 && (
          <div className="bg-white rounded-2xl border border-gray-100 py-20 text-center">
            ...
            <p className="text-gray-400 text-xs mt-1">
              Files from customers will appear here
            </p>
          </div>
        )}
          ...
          <div className="space-y-2.5">
            {files.map((f) => {
              ...
              return (
                <div
                  key={f._id}
                  className={`bg-white rounded-2xl border border-gray-100 p-4 flex items-center gap-4 hover:border-indigo-100 hover:shadow-md hover:shadow-gray-100/60 transition-all duration-200 ${
                    isDeleting
                ...
                >
                  {/* File Type Badge */}
                  <div
                    className={`shrink-0 w-11 h-11 rounded-xl border flex items-center justify-center text-[10px] font-bold tracking-wide ${extColor(
                      ext
                    )}`}
                  >
                    {ext.slice(0, 4)}
